...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "G_CHAN_NUM" -parent ${Page_0}
...
proc update_PARAM_VALUE.G_CHAN_NUM { PARAM_VALUE.G_CHAN_NUM } {
	# Procedure called to update G_CHAN_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.G_CHAN_NUM { PARAM_VALUE.G_CHAN_NUM } {
	# Procedure called to validate G_CHAN_NUM
	return true
}
...
proc update_MODELPARAM_VALUE.G_CHAN_NUM { MODELPARAM_VALUE.G_CHAN_NUM PARAM_VALUE.G_CHAN_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.G_CHAN_NUM}] ${MODELPARAM_VALUE.G_CHAN_NUM}
}
